        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _this.getData(_this.page, _this.page_size);
            case 3:
            case "end":
  ...
  methods: {
    ...
    _del: function _del() {
      ...
      setTimeout(function () {
        ...
        _this3.nextCard(_this3.moveX, _this3.moveY);
        console.log("_del==datalistlent,pageidx---------------", _this3.dataList.length);
        if (_this3.dataList.length == 1) {
          _this3.page++;
          console.log("load new words", _this3.page);
          _this3.getData(_this3.page, _this3.page_size);
        }
        if (_this3.type) {}
      }, this.delTime);
